...
internal static partial class MessageFactoryLogger
{
    ...
    public static partial void ErrorWhileParseHttpRequest(this ILogger logger, MessageAction action, Exception exception);
    
    [LoggerMessage(Level = LogLevel.Error, Message = "Error while parse Http Message for \"{action}\" type of event")]
    public static partial void ErrorWhileParseHttpMessage(this ILogger logger, MessageAction action, Exception exception); 
    
    [LoggerMessage(Level = LogLevel.Error, Message = "Error while parse Initiator Message for \"{action}\" type of event")]
    public static partial void ErrorWhileParseInitiatorMessage(this ILogger logger, MessageAction action, Exception exception);
}
