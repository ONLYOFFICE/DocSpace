...
public class OCMigratingContacts : MigratingContacts
{
    ...
    private readonly List<OCContact> _contacts = new List<OCContact>();
    private readonly TenantManager _tenantManager;
    private readonly OCMigratingUser _user;
    private readonly OCAddressbooks _addressbooks;

    public OCMigratingContacts(TenantManager tenantManager, OCMigratingUser user, OCAddressbooks addressbooks, Action<string, Exception> log) : base(log)
    {
