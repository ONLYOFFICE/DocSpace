...
{
    public class AuthSignatureAttribute : AuthorizationFilterAttribute
    {
        private readonly string AllowskipCfgName;
        ...
        {
            AuthSignatureService.OnAuthorization(context, AllowskipCfgName);
        }
    }
}