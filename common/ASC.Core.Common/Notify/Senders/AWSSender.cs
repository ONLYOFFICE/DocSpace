...
namespace ASC.Core.Notify.Senders
{
    ...
    public class AWSSender : SmtpSender
    {
        ...
        private AmazonSimpleEmailServiceClient _amazonServiceClient;
        ...
        public override void Init(IDictionary<string, string> properties)
        {
            ...
            _amazonServiceClient = new AmazonSimpleEmailServiceClient(properties["accessKey"], properties["secretKey"], region);
        ...
        private NoticeSendResult SendMessage(NotifyMessage m)
        {
            ...
            var response = _amazonServiceClient.SendEmailAsync(request).Result;
            ...
            lock (_locker)
            {
                if (IsRefreshNeeded())//Double check
                {
                    ...
                    try
                    {
                        ...
                        _quota = _amazonServiceClient.GetSendQuotaAsync(r).Result;
        ...
        private bool IsRefreshNeeded() => _quota == null || (DateTime.UtcNow - _lastRefresh) > _refreshTimeout;
    }
    ...
    {
        public static void Register(DIHelper services) => services.TryAdd<AWSSenderScope>();
    }
}