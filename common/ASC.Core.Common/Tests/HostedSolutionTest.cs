...
namespace ASC.Core.Common.Tests
{
    ...
    public class HostedSolutionTest
    {
        ...
        {
            var h = new HostedSolution(null, null, null, null, Configuration.GetConnectionStrings("core"), null);
        ...
        {
            var regionSerice = new MultiRegionHostedSolution("site", null, null, null, null, null, null);
