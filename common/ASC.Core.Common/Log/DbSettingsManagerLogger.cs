...
internal static partial class DbSettingsManagerLogger
{
    ...
    public static partial void ErrorSaveSettingsFor(this ILogger logger, Exception exception); 
    
    [LoggerMessage(Level = LogLevel.Error, Message = "LoadSettingsFor")]
    public static partial void ErrorLoadSettingsFor(this ILogger logger, Exception exception);
}
