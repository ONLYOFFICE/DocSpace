...
namespace ASC.Core.Common.Migrations.MySql.TenantDbContextMySql
{
    ...
    [Migration("20210309095116_TenantDbContextMySql")]
            ...
            modelBuilder.Entity("ASC.Core.Common.EF.Model.DbCoreSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModified = new DateTime(2021, 3, 9, 9, 51, 15, 578, DateTimeKind.Utc).AddTicks(9424),
                        ...
                        new
                        {
                            ...
                            LastModified = new DateTime(2021, 3, 9, 9, 51, 15, 579, DateTimeKind.Utc).AddTicks(80),
                        ...
                        new
                        {
                            Tenant = -1,
                            Id = "SmtpSettings",
                            LastModified = new DateTime(2021, 3, 9, 9, 51, 15, 579, DateTimeKind.Utc).AddTicks(86),
            ...
            modelBuilder.Entity("ASC.Core.Common.EF.Model.DbTenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Alias = "localhost",
                            Calls = false,
                            CreationDateTime = new DateTime(2021, 3, 9, 9, 51, 15, 575, DateTimeKind.Utc).AddTicks(8295),
            ...
            modelBuilder.Entity("ASC.Core.Common.EF.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModified = new DateTime(2021, 3, 9, 9, 51, 15, 567, DateTimeKind.Utc).AddTicks(3402),
                            LastName = "",
                            PhoneActivation = 0,
                            Removed = false,
                            Status = 1,
                            ...
                            WorkFromDate = new DateTime(2021, 3, 9, 9, 51, 15, 567, DateTimeKind.Utc).AddTicks(2006)
                        });
                });
