    ...
    public partial class UserDbContextPostgreSql : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "groupid", "ref_type", "tenant", "userid", "last_modified" },
                values: new object[] { "cd84e66b-b803-40fc-99f9-b2969a54a1de", 0, 1, "66faa6e4-f133-11ea-b126-00ffeec8b4ef", new DateTime(2022, 7, 8, 0, 0, 0, 0, DateTimeKind.Unspecified) });
