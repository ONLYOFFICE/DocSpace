...
namespace ASC.Core.Common.Migrations.PostgreSql.InstanceRegistrationContextPostgreSql
{
    public partial class InstanceRegistrationContextPostgreSql : Migration
    {
