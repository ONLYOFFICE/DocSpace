        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_modifed_by = table.Column<Guid>(type: "uuid", maxLength: 38, nullable: true, defaultValueSql: "NULL"),
                    last_modifed_on = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, defaultValueSql: "NULL"),
                    display_name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true, defaultValueSql: "NULL"),
                    is_shared = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dial_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    dial_duration = table.Column<int>(type: "integer", nullable: true),
                    ...
                    record_duration = table.Column<int>(type: "integer", nullable: true),
                    record_price = table.Column<decimal>(type: "numeric(10,4)", nullable: false),
                    contact_id = table.Column<int>(type: "integer", nullable: true),
                    price = table.Column<decimal>(type: "numeric(10,4)", nullable: true, defaultValueSql: "NULL"),
                    tenant_id = table.Column<int>(type: "integer", nullable: false),
