            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    industry = table.Column<string>(type: "varchar(255)", nullable: true, collation: "utf8_general_ci")
                        .Annotation("MySql:CharSet", "utf8"),
                    status_id = table.Column<int>(type: "int", nullable: false, defaultValueSql: "'0'"),
                    company_id = table.Column<int>(type: "int", nullable: false),
                    contact_type_id = table.Column<int>(type: "int", nullable: false, defaultValueSql: "'0'"),
                    ...
                    last_modifed_by = table.Column<string>(type: "char(38)", nullable: true, collation: "utf8_general_ci")
                        .Annotation("MySql:CharSet", "utf8"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    answered_by = table.Column<string>(type: "varchar(50)", nullable: false, defaultValueSql: "'00000000-0000-0000-0000-000000000000'", collation: "utf8_general_ci")
                        .Annotation("MySql:CharSet", "utf8"),
                    dial_date = table.Column<DateTime>(type: "datetime", nullable: true),
                    dial_duration = table.Column<int>(type: "int", nullable: true),
                    ...
                    record_url = table.Column<string>(type: "text", nullable: true, collation: "utf8_general_ci")
                        .Annotation("MySql:CharSet", "utf8"),
                    record_duration = table.Column<int>(type: "int", nullable: true),
