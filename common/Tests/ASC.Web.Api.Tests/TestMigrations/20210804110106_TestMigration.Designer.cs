            ...
            modelBuilder.Entity("ASC.Core.Common.EF.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModified = new DateTime(2021, 8, 4, 11, 1, 4, 513, DateTimeKind.Utc).AddTicks(1842),
                            LastName = "",
                            PhoneActivation = 0,
                            Removed = false,
                            Status = 1,
                            ...
                            WorkFromDate = new DateTime(2021, 8, 4, 11, 1, 4, 512, DateTimeKind.Utc).AddTicks(9355)
                        },
                        new
                        {
                            Id = "99223c7b-e3c9-11eb-9063-982cbc0ea1e5",
                            ActivationStatus = 0,
                            CreateOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "test@gmail.com",
                            FirstName = "Test",
                            LastModified = new DateTime(2021, 8, 4, 11, 1, 4, 513, DateTimeKind.Utc).AddTicks(2928),
                            LastName = "User",
                            PhoneActivation = 0,
                            Removed = false,
                            Status = 1,
                            Tenant = 1,
                            UserName = "TestUser",
                            WorkFromDate = new DateTime(2021, 8, 4, 11, 1, 4, 513, DateTimeKind.Utc).AddTicks(2940)
                        });
                });
            ...
            modelBuilder.Entity("ASC.Core.Common.EF.UserSecurity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = "66faa6e4-f133-11ea-b126-00ffeec8b4ef",
                            LastModified = new DateTime(2021, 8, 4, 11, 1, 4, 554, DateTimeKind.Utc).AddTicks(8500),
