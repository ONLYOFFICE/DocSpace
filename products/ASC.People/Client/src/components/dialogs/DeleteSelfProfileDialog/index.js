...
const DeleteSelfProfileDialog = inject(({ auth }) => ({ theme: auth.settingsStore.theme }))(
  observer(
    withTranslation(['DeleteSelfProfileDialog', 'Common'])(DeleteSelfProfileDialogComponent),
  ),
);
