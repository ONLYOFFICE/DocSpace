...
namespace ASC.Web.CRM.Core.Search
{
    ...
    public sealed class FactoryIndexerContactInfo : FactoryIndexer<DbContactInfo>
    {
        public FactoryIndexerContactInfo(
            ...
            BaseIndexer<DbContactInfo> baseIndexer,
        ...
        public override void IndexAll()
        {
            ...
            IQueryable<DbContactInfo> GetBaseQuery(DateTime lastIndexed) =>
                                entityDao.CrmDbContext.ContactsInfo
                                        .AsQueryable()
            ...
            List<DbContactInfo> getData(long start, long stop, DateTime lastIndexed) =>
