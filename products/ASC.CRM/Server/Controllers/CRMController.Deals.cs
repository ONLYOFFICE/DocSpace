...
namespace ASC.Api.CRM
{
    public partial class CRMController
    {
        ...
        public IEnumerable<OpportunityWrapper> SetAccessToBatchDeal(SetAccessToBatchDealByFilterInDto inDto)
        {
        ...
        public IEnumerable<OpportunityWrapper> SetAccessToBatchDeal(SetAccessToBatchDealInDto inDto)
        {
        ...
        ///<exception cref="ArgumentException"></exception>
        [Create(@"opportunity")]
        public OpportunityWrapper CreateDeal(CreateOrUpdateDealInDto inDto)
        {
