...
{
    [TestFixture]
    internal class BadContentTests : MessageParserTestsBase
    {
        [Test]
        ...
        [Test]
        public void ShouldParseMessage14612877700000000705()
        {
            Test("Message14612877700000000705.eml");
        }

        [Test]
        public void ShouldParseMessage14634459670000000606()
        {
            Test("Message14634459670000000606.eml");
        }

        [Test]
        public void ShouldParseUber()
        {
            Test("Uber.eml");
        }

        [Test]
        public void ShouldParseUndeliverable_iwdvs_atn_pay_thisbill_01652567()
        {
            Test("Undeliverable_iwdvs_atn_pay_thisbill_01652567.eml");
        }

        [Test]
        public void ShouldParseUndelivered_Mail_Returned_to_Sender()
        {
            Test("Undelivered_Mail_Returned_to_Sender.eml");
        }

        [Test]
        public void ShouldParsebad_content_type()
        {
            Test("bad_content_type.eml");
        }

        [Test]
        public void ShouldParsecorrupted_mailMessage()
        {
            Test("corrupted_mailMessage.eml");
        }

        [Test]
        public void ShouldParsedostavka_ru_bad_content_type()
        {
            Test("dostavka_ru_bad_content_type.eml");
        }

        [Test]
        public void ShouldParseembedded_smile_not_parsed()
        {
            Test("embedded_smile_not_parsed.eml");
        }

        [Test]
        public void ShouldParseiphone_yandex_with_inline_image()
        {
            Test("iphone_yandex_with_inline_image.eml");
        }

        [Test]
        public void ShouldParsewith_attachments()
        {
            Test("with_attachments.eml");
        }

        [Test]
        public void ShouldParsewith_mht()
        {
            Test("with_mht.eml");
        }

        [Test]
        public void ShouldParseDeliveryReport()
        {
            Test("MAILER-DAEMON.eml");
        }
    }
}
