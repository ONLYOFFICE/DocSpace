...
{
    [TestFixture]
    internal class MessageDeserializationTest : MessageParserTestsBase
    {
        private const string TEST_FILE_NAME = "test_serialization.eml";
        private static readonly string TestFilePath = TestFolderPath + TEST_FILE_NAME;
        ...
        {
            var testMail = MailClient.ParseMimeMessage(TestFilePath);
