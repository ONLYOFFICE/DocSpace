...
namespace ASC.Mail.Core.Dao
{
    ...
    public static class ServerAddressDaoExtension
    {
        public static DIHelper AddServerAddressDaoService(this DIHelper services)
        {
            services.TryAddScoped<ServerAddressDao>();
