...
namespace ASC.Projects.Model
{
    ...
    public class ModelHelper
    {
        ...
        {
            var model = (ParticipantWrapper)EmployeeWraperFullHelper.GetFull(participant.UserInfo);
        ...
        public FolderContentWrapper<int> GetFolderContentWrapper(int folderId, Guid userIdOrGroupId, FilterType filterType)
        {
            OrderBy orderBy = null;
            if (Enum.TryParse(Context.SortBy, true, out SortedByType sortBy))
            {
                orderBy = new OrderBy(sortBy, !Context.SortDescending);
            }
