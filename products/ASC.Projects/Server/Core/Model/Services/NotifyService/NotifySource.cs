...
using ASC.Projects.Core.Model.Resources;
...
namespace ASC.Projects.Core.Services.NotifyService
{
    ...
    public class NotifySource : NotifySourceBase
    {
        ...
        public NotifySource(UserManager userManager, IRecipientProvider recipientsProvider, SubscriptionManager subscriptionManager)
            : base(new Guid("{6045B68C-2C2E-42db-9E53-C272E814C4AD}").ToString(), userManager, recipientsProvider, subscriptionManager)
        {
        }
        ...
        {
            return new XmlPatternProvider2(ProjectsPatternResource.patterns) { GetPatternMethod = ChoosePattern };
        }
