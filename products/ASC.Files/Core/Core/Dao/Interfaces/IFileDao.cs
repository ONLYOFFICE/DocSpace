...
public interface IFileDao<T>
{
    ...
    /// </remarks>
    IAsyncEnumerable<File<T>> GetFilesAsync(T parentId, OrderBy orderBy, FilterType filterType, bool subjectGroup, Guid subjectID, string searchText, bool searchInContent, T roomId = default, bool withSubfolders = false, bool exludeSubject = false, bool withOrigin = false);
