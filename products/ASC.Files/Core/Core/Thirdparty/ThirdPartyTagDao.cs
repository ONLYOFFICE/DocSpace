...
[Scope]
internal class ThirdPartyTagDao<TFile, TFolder, TItem> : IThirdPartyTagDao<IProviderInfo<TFile, TFolder, TItem>>
    ...
    where TItem : class
{
    ...
    public void Init(BaseProviderInfo<IProviderInfo<TFile, TFolder, TItem>> providerInfo)
    {
