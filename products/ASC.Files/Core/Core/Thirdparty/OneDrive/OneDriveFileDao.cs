...
internal class OneDriveFileDao : OneDriveDaoBase, IFileDao<string>
{
    ...
    public async IAsyncEnumerable<File<string>> GetFilesAsync(string parentId, OrderBy orderBy, FilterType filterType, bool subjectGroup, Guid subjectID, string searchText, bool searchInContent, string roomId = default, bool excludeSubject = false, bool withoutMe = false, bool withOrigin = false)
    {
