...
public interface ISecurityDao<T>
{
    ...
    IAsyncEnumerable<UserWithShared> GetUsersWithSharedAsync(FileEntry<T> entry, string text, EmployeeActivationStatus? status, bool excludeShared, int offset = 0, int count = -1);
