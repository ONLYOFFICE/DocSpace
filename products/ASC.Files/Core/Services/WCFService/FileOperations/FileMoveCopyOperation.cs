                ...
                try
                {
                    ...
                    if (copy || conflictFolder != null)
                    {
                        ...
                        else
                        {
                            ...
                            await filesMessageService.Send(newFolder, toFolder, _headers, MessageAction.FolderCopied, newFolder.Title, toFolder.Title);
                        ...
                        else
                        {
                            if (conflictFolder != null)
                            {
                                ...
                                if (copy)
                                {
                                    ...
                                    await filesMessageService.Send(newFolder, toFolder, _headers, MessageAction.FolderCopiedWithOverwriting, newFolder.Title, toFolder.Title);
                                ...
                                else
                                {
                                    ...
                                    await filesMessageService.Send(folder, toFolder, _headers, MessageAction.FolderMovedWithOverwriting, folder.Title, toFolder.Title);
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (isRoom)
                            {
                                ...
                                {
                                    await filesMessageService.Send(folder, _headers, MessageAction.RoomArchived, folder.Title);
                                }
                                else
                                {
                                    await filesMessageService.Send(folder, _headers, MessageAction.RoomUnarchived, folder.Title);
                                }
                            }
                            else
                            {
                                await filesMessageService.Send(folder, toFolder, _headers, MessageAction.FolderMovedFrom, folder.Title, parentFolder.Title, toFolder.Title);
                            }
                    ...
                    if (conflict == null)
                    {
                        ...
                        if (copy)
                        {
                            try
                            {
                                ...
                                await filesMessageService.Send(newFile, toFolder, _headers, MessageAction.FileCopied, newFile.Title, parentFolder.Title, toFolder.Title);
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                await filesMessageService.Send(file, toFolder, _headers, MessageAction.FileMoved, file.Title, parentFolder.Title, toFolder.Title);
                    ...
                    else
                    {
                        if (_resolveType == FileConflictResolveType.Overwrite)
                        {
                            ...
                            else
                            {
                                ...
                                if (copy)
                                {
                                    await filesMessageService.Send(newFile, toFolder, _headers, MessageAction.FileCopiedWithOverwriting, newFile.Title, parentFolder.Title, toFolder.Title);
                                    if (ProcessedFile(fileId))
                                    {
                                        sb.Append($"file_{newFile.Id}{SplitChar}");
                                    }
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            await filesMessageService.Send(file, toFolder, _headers, MessageAction.FileMovedWithOverwriting, file.Title, parentFolder.Title, toFolder.Title);
