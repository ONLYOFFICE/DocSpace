...
public class PathProvider
{
    ...
    {
        return _commonLinkUtility.GetFullAbsolutePath($"/rooms/shared/{roomId}/filter?withSubfolders=true&folder={roomId}&count=100&page=1&sortby=DateAndTime&sortorder=descending");
    }
