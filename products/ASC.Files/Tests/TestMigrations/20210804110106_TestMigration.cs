...
public partial class TestMigration : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        //    values: new object[] { 0, 0, "my", 5, "66faa6e4-f133-11ea-b126-00ffeec8b4ef", new DateTime(2021, 8, 4, 11, 1, 4, 513, DateTimeKind.Utc).AddTicks(1842), "66faa6e4-f133-11ea-b126-00ffeec8b4ef", new DateTime(2021, 8, 4, 11, 1, 4, 513, DateTimeKind.Utc).AddTicks(1842), 1, 0, 0 });

        //migrationBuilder.InsertData(
        //    table: "files_folder",
        //    columns: new[] { "id", "parent_id", "title", "folder_type", "create_by", "create_on", "modified_by", "modified_on", "tenant_id", "foldersCount", "filesCount" },
        //    values: new object[] { 0, 0, "my", 5, "005bb3ff-7de3-47d2-9b3d-61b9ec8a76a5", new DateTime(2021, 8, 4, 11, 1, 4, 513, DateTimeKind.Utc).AddTicks(1842), "005bb3ff-7de3-47d2-9b3d-61b9ec8a76a5", new DateTime(2021, 8, 4, 11, 1, 4, 513, DateTimeKind.Utc).AddTicks(1842), 1, 0, 0 });
    }
