...
class ConnectClouds extends React.Component {
  ...
  openLocation = (e) => {
    ...
    const isCorporate =
      !!providers.length && providers.find((p) => p.provider_key === provider).corporate;
          ...
          <>
            ...
            <RowContainer useReactWindow={false}>
              {providers.map((item, index) => {
                ...
                const typeTitle = connectedCloudsTypeTitleTranslation(item.provider_key, t);
                  ...
                  <Row
                    ...
                    <Box
                      ...
                      <Text
                        ...
                        noSelect>
                        {tReady ? typeTitle : <Loaders.Rectangle width="90px" height="10px" />}
                      </Text>
                      <Link
                        type="page"
...
})(withTranslation(['Settings', 'Translations'])(observer(withRouter(ConnectClouds))));
