...
namespace ASC.Files.Thirdparty.Sharpbox
{
    internal class SharpBoxDaoSelector : RegexDaoSelectorBase<string>
    {
        ...
        {
            var res = ServiceProvider.GetService<SharpBoxFileDao>();
        ...
        {
            var res = ServiceProvider.GetService<SharpBoxFolderDao>();
        ...
        {
            var res = ServiceProvider.GetService<SharpBoxTagDao>();
        ...
        {
            var res = ServiceProvider.GetService<SharpBoxSecurityDao>();
        ...
        private SharpBoxInfo GetInfo(string objectId)
        {
