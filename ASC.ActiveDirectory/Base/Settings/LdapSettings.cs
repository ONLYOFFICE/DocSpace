...
namespace ASC.ActiveDirectory.Base.Settings
{
    ...
    public class LdapSettings : ISettings, ICloneable
    {
        ...
        private readonly DbContextManager<WebstudioDbContext> webstudioDbContextManager;
        private readonly Lazy<WebstudioDbContext> lazyWebstudioDbContext;
        private readonly DbContextManager<TenantDbContext> tenantDbContextManager;
        private readonly Lazy<TenantDbContext> lazyTenantDbContext;
            ...
            DbContextManager<TenantDbContext> tenantDbContext)
        {
            ...
            webstudioDbContextManager = webstudioDbContext;
            lazyWebstudioDbContext = new Lazy<WebstudioDbContext>(() => webstudioDbContextManager.Value);
            tenantDbContextManager = tenantDbContext;
            lazyTenantDbContext = new Lazy<TenantDbContext>(() => tenantDbContextManager.Value);
        ...
        public ISettings GetDefault(IServiceProvider serviceProvider)
        {
            ...
            var settings = new LdapSettings(settingsManager, webstudioDbContextManager, tenantDbContextManager)
            {
                Server = "",
                UserDN = "",
        ...
        public List<MappingFields> GetImportedFields { get { return settingsManager.Load<LdapSettings>().LdapMapping.Keys.ToList(); } }
