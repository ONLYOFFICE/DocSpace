...
namespace AppLimit.CloudComputing.SharpBox
{
    public partial class CloudStorage
    {
        ...
        /// <returns></returns>
        public bool SynchronizeFolder(DirectoryInfo srcFolder, ICloudDirectoryEntry tgtFolder, SyncFolderFlags flags)
        {
            // init ret value 
            var bRet = true;
        ...
        /// <param name="flags"></param>
        /// <returns></returns>
        public bool SynchronizeFolder(string srcFolder, string tgtFolder, SyncFolderFlags flags)
        {
            // check parameters
