    ...
    for (let i = 0; i < arrayOfParams.length || i < 2; i++) {
        ...
        switch (i) {
            case 0:
                ...
                key = groupIndex || groupIndex === 0
                    ? settingsTree[groupIndex].key + "-0"
                    : key
                break

            case 1:
                categoryIndex = getSettingsIndex(settingsTree, currentParam, groupIndex);
                key = (categoryIndex || categoryIndex === 0) && (groupIndex || groupIndex === 0)
