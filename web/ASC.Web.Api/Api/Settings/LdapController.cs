...
public class LdapController : BaseSettingsController
{
    ...
    /// </short>
    /// <category>LDAP</category>
    /// <returns type="ASC.Web.Api.ApiModels.ResponseDto.LdapCronSettingsDto, ASC.Web.Api.ApiModels.ResponseDto">LDAP cron settings: cron expression</returns>
    ...
    /// <category>LDAP</category>
    /// <path>api/2.0/settings/ldap/cron</path>
    /// <param type="ASC.Web.Api.ApiModels.RequestsDto.LdapCronRequestDto, ASC.Web.Api.ApiModels.RequestsDto" name="ldapCronRequest">LDAP cron request parameters</param>
    ...
    /// <httpMethod>GET</httpMethod>
    /// <returns type="ASC.Web.Api.ApiModels.ResponseDto.LdapStatusDto, ASC.Web.Api.ApiModels.ResponseDto">LDAP operation status: completed or not, ID, status, error, warning, percentage of completion, certificate confirmation request, source, operation type</returns>
    [HttpGet("ldap/sync")]
    ...
    /// </short>
    /// <category>LDAP</category>
    /// <param type="ASC.Web.Api.ApiModels.RequestsDto.LdapRequestsDto, ASC.Web.Api.ApiModels.RequestsDto" name="ldapRequestsDto">LDAP settings</param>
    /// <returns type="ASC.Web.Api.ApiModels.ResponseDto.LdapStatusDto, ASC.Web.Api.ApiModels.ResponseDto">LDAP operation status: completed or not, ID, status, error, warning, percentage of completion, certificate confirmation request, source, operation type</returns>
    /// <path>api/2.0/settings/ldap</path>
    /// <httpMethod>POST</httpMethod>
    [HttpPost("ldap")]
    ...
    /// </short>
    /// <category>LDAP</category>
    /// <returns type="ASC.Web.Api.ApiModels.ResponseDto.LdapSettingsDto, ASC.Web.Api.ApiModels.ResponseDto">LDAP default settings: enable LDAP authentication or not, start TLS or not, enable SSL or not, send welcome email or not, server name, user name, port number, user filter, login attribute, LDAP settings mapping, access rights, user is a group member or not, group name, user attribute, group filter, group attribute, group name attribute, authentication is enabled or not, login, password, accept certificate or not</returns>
