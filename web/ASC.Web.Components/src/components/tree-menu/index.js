...
const StyledTreeMenu = styled(Tree)`
    ...
    li.drag-over-gap-top > .draggable {
    ...
    li span.rc-tree-switcher.rc-tree-icon__customize,
    li span.rc-tree-checkbox.rc-tree-icon__customize,
    li span.rc-tree-iconEle.rc-tree-icon__customize {
        background-image: none;
    }
    li span.rc-tree-icon_loading {
    margin-right: 2px;
    vertical-align: top;
        background: url('data:image/gif;base64,') no-repeat scroll 0 0 transparent;
    }
    li span.rc-tree-switcher.rc-tree-switcher-noop {
        cursor: auto;
    }
    ...
    li span.rc-tree-checkbox-checked {
        background-position: -14px 0;
    }
    li span.rc-tree-checkbox-indeterminate {
        background-position: -14px -28px;
    }
    li span.rc-tree-checkbox-disabled {
        background-position: 0 -56px;
    }
    li span.rc-tree-checkbox.rc-tree-checkbox-checked.rc-tree-checkbox-disabled {
        background-position: -14px -56px;
    }
    li span.rc-tree-checkbox.rc-tree-checkbox-indeterminate.rc-tree-checkbox-disabled {
        position: relative;
        background: #ccc;
        border-radius: 3px;
    }
    li span.rc-tree-checkbox.rc-tree-checkbox-indeterminate.rc-tree-checkbox-disabled::after {
        content: ' ';
