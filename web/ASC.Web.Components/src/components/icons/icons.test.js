...
describe('<Icons />', () => {
  ...
  it('size small', () => {
    const wrapper = mount(
      <Icons.AZSortingIcon size="small" />
    );
  ...
  it('size medium', () => {
    const wrapper = mount(
      <Icons.AZSortingIcon size="medium" />
    );
  ...
  it('size scale', () => {
    const wrapper = mount(
      <Icons.AZSortingIcon size="scale" />
    );
