...
describe("<ModuleTile />", () => {
  ...
  it("accepts id", () => {
    const wrapper = mount(<ModuleTile {...baseProps} id="testId" />);

    expect(wrapper.prop("id")).toEqual("testId");
  });

  it("accepts className", () => {
    const wrapper = mount(<ModuleTile {...baseProps} className="test" />);
  ...
  it("added onClick prop", () => {
    ...
    const wrapper = mount(<ModuleTile {...baseProps} onClick={onClick} />);

    expect(wrapper.prop("onClick")).toEqual(onClick);
  });

  it("not isPrimary prop", () => {
    const wrapper = mount(<ModuleTile {...baseProps} isPrimary={false} />);
