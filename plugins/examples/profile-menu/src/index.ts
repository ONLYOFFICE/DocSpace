...
class Profilemenu implements IPlugin, IProfileMenuPlugin {
  ...
  // return Map<PluginItems, Map<string, IContextMenuItem | IProfileMenuItem | IProfileMenuItem | ISeparatorItem>>
...
items.forEach((item) => profilemenu.addProfileMenuItem(item));
...
window.Plugins.Profilemenu = profilemenu || {};
