...
class Newtabplugin implements IPlugin, IContextMenuPlugin {
...
const newtabplugin = new Newtabplugin();

const items = getItems();

items.forEach((item) => {
  newtabplugin.addContextMenuItem(item);
});
...
window.Plugins.Newtabplugin = newtabplugin || {};
