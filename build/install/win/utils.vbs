...
Function MySQLConfigure
    ...
    If Err.Number = 0 Then
		...
		If service.Started Then			
            ...
            shell.Run """" & installDir & "bin\mysql"" -u root -p" & dbpass & " -e ""ALTER USER 'root'@'localhost' IDENTIFIED WITH caching_sha2_password BY " & "'" & dbpass & "';""", 0, true	
        End If        
        ...
        WriteIni filesys.BuildPath(dataDir, "my.ini"), "mysqld", "default-authentication-plugin", "caching_sha2_password"
