%install
mkdir -p "%{buildroot}/var/log/onlyoffice/appserver/"
mkdir -p "%{buildroot}/etc/onlyoffice/appserver/data/"
...
cp -r %{_builddir}/etc/onlyoffice/appserver/* "%{buildroot}/etc/onlyoffice/appserver/"
...
cp -r %{_builddir}/services/urlshortener/client/* "%{buildroot}/services/urlshortener/client/"
cp -r %{_builddir}/services/thumb/client/* "%{buildroot}/services/thumb/client/"
cp -r %{_builddir}/etc/systemd/system/* "%{buildroot}/etc/systemd/system/"
cp -r %{_builddir}/usr/bin/* "%{buildroot}/usr/bin/"
cp -r %{_builddir}/services/socket/service/* "%{buildroot}/services/socket/service/"
cp -r %{_builddir}/services/ASC.Socket.IO/* "%{buildroot}/services/ASC.Socket.IO/"
