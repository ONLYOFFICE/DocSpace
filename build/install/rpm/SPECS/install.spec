...
cp -rf %{_builddir}/%{sourcename}/config/nginx/includes/*.conf "%{buildroot}%{_sysconfdir}/nginx/includes/"
cp -rf %{_builddir}/%{sourcename}/config/nginx/*.conf "%{buildroot}%{_sysconfdir}/nginx/conf.d/"
