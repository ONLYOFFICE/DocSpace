...
COPY /config/nginx/templates/upstream.conf.template /etc/nginx/templates/10.upstream.conf.upstream
COPY /config/nginx/templates/map.conf.template /etc/nginx/templates/10.map.conf.map
