...
public partial class MigrationContextMigrate : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.InsertData(
            table: "tenants_quota",
            columns: new[] { "tenant", "features", "name" },
            columnTypes: new[] { "int", "text", "varchar(128)" },
            values: new object[] { -1, "audit,ldap,sso,whitelabel,thirdparty,restore,oauth,contentsearch,file_size:102400", "default" });
    }
